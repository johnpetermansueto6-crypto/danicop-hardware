...
// Get driver's assigned deliveries (active: assigned, picked_up, delivering)
...
<body class="bg-gray-50">
    ...
    <div class="ml-64">
        ...
        <nav class="bg-green-600 text-white shadow-lg">
            <div class="px-6 py-4">
                <h1 class="text-xl font-bold"><i class="fas fa-clipboard-list mr-2"></i>Assigned Deliveries</h1>
                <p class="text-sm text-green-100 mt-1">Orders assigned to you by staff - awaiting delivery</p>
            </div>
        </nav>
        ...
        <div class="p-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 mb-6">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-blue-600"><?= $activeDeliveries->num_rows ?></p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md overflow-hidden">
                <div class="bg-green-600 text-white px-6 py-4">
                    <h2 class="text-xl font-bold"><i class="fas fa-list mr-2"></i>My Assigned Deliveries</h2>
                </div>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="py-8 text-center text-gray-500">
                                        ...
                                        <p class="text-sm mt-2">Staff will assign deliveries to you here</p>
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
    ...
    function updateStatus(assignmentId, currentStatus) {
        ...
        Swal.fire({
            ...
            preConfirm: () => {
                ...
                // Validate signature
                if (!canvas) {
                    Swal.showValidationMessage('Signature canvas not found');
                    return false;
                }
                ...
                if (result.isConfirmed && result.value) {
                    ...
                    .then(data => {
                        if (data.success) {
                            ...
                            let errorMsg = data.message || 'Failed to mark as delivered';
                            if (data.debug) {
                                console.error('Debug info:', data.debug);
                                errorMsg += '\n\nFile: ' + (data.debug.file || 'N/A') + ', Line: ' + (data.debug.line || 'N/A');
                            }
                    ...
                    .catch(error => {
                        ...
                        Swal.fire({
                            title: 'Error!',
                            text: error.message || 'An error occurred while updating. Please check the browser console (F12) for details.',
                            icon: 'error',
                            confirmButtonText: 'OK'
                        });
                    });

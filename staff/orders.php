...
// Handle status update (staff can update status)
...
// Filter orders - Staff focuses on pending/active orders
...
<head>
    ...
    <title>Manage Orders - Staff - Danicop Hardware</title>
    ...
    <div class="space-y-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-2">
            ...
            <form method="GET" class="inline-block">
                <select name="status" onchange="this.form.submit()" class="px-4 py-2 border border-gray-300 rounded-lg bg-white text-sm">
                    <option value="">All Orders</option>
                    <option value="pending" <?= $status_filter === 'pending' ? 'selected' : '' ?>>Pending (Incoming)</option>
